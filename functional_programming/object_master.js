...
const typeIfSecondIsFlying = pokémon.filter(p => p.types[ 1] == "flying").map(p => p.types [0]);
console.log (typeIfSecondIsFlying)

// a count of the number of pokémon that are "normal" type
const countNormal = pokémon.filter (p => p.types =="normal");
